    ...
    def _seed_sample_data(self, admin_id: int) -> None:
        ...
        samples = [
            ...
            },
            {
                ...
                "phone": "+60123456785",
                "plant": "P2",
                "complaint_text": "Cannot access the internal portal. Getting 'Access Denied' error when trying to log in.",
                "kind": ComplaintKind.complaint,
                "category": "IT",
                "priority": Priority.urgent,
            ...
            },
            {
                ...
                "phone": "+60123456786",
                "plant": "P1",
                "complaint_text": "Printer on Floor 3 keeps jamming. Wasted a lot of paper trying to print important documents.",
                "kind": ComplaintKind.complaint,
                "category": "IT",
            ...
            },
            {
                ...
                "phone": "+60123456787",
                "plant": "BK",
                "complaint_text": "Parking lot lighting is insufficient. Very dark and unsafe in the evenings.",
                "kind": ComplaintKind.complaint,
                "category": "Facilities",
                "priority": Priority.urgent,
                "status": ComplaintStatus.in_progress,
                "ai_confidence": 0.82,
                "kind_confidence": 0.80,
            ...
            },
            {
                ...
                "phone": "+60123456788",
                "plant": "P1",
                "complaint_text": "Last month's overtime hours are not reflected in my payslip.",
                "kind": ComplaintKind.complaint,
                "category": "Payroll",
                "priority": Priority.normal,
                "status": ComplaintStatus.in_progress,
                "ai_confidence": 0.86,
                "kind_confidence": 0.83,
            ...
            # HR Issues
            {
                ...
                "phone": "+60123456789",
                "plant": "P2",
                "complaint_text": "Submitted leave application 2 weeks ago but still haven't received approval.",
                "kind": ComplaintKind.complaint,
                "category": "HR",
                "priority": Priority.normal,
                "status": ComplaintStatus.pending,
                "ai_confidence": 0.81,
                "kind_confidence": 0.79,
            ...
            },
            {
                ...
                "phone": "+60123456790",
                "plant": "P1",
                "complaint_text": "Want to know about the health insurance benefits. The information packet is confusing.",
                "kind": ComplaintKind.complaint,
                "category": "HR",
                "priority": Priority.normal,
                "status": ComplaintStatus.resolved,
                "ai_confidence": 0.77,
                "kind_confidence": 0.75,
            ...
            # Safety Issues
            {
                ...
                "phone": "+60123456791",
                "plant": "BK",
                "complaint_text": "Fire extinguisher on Floor 2 needs refilling. Tag shows it's overdue for inspection.",
                "kind": ComplaintKind.complaint,
                "category": "Safety",
                "priority": Priority.urgent,
                "status": ComplaintStatus.in_progress,
                "ai_confidence": 0.91,
                "kind_confidence": 0.89,
            ...
            },
            {
                ...
                "phone": "+60123456792",
                "plant": "P2",
                "complaint_text": "Floor in the warehouse is wet and slippery. Someone could get hurt.",
                "kind": ComplaintKind.complaint,
                "category": "Safety",
                "priority": Priority.urgent,
                "status": ComplaintStatus.pending,
