...
var FileUpload = function (_a) {
    ...
    return (<div className="space-y-2">
      <button onClick={handleClick} disabled={uploading || disabled} className="w-full rounded-lg border border-dashed border-slate-300 py-4 text-sm font-medium text-slate-600 hover:bg-slate-50 disabled:opacity-50">
