      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 animate-scale-in">
        ...
        <div className="p-6">
          ...
          <div className="flex gap-3">
            <button
              onClick={onCancel}
              className="flex-1 px-5 py-3 rounded-xl font-bold text-sm bg-white border-2 border-slate-200 text-slate-700 hover:bg-slate-50 transition-all"
            >
              {cancelText}
            </button>
            <button
              onClick={onConfirm}
              className={`flex-1 px-5 py-3 rounded-xl font-bold text-sm text-white shadow-lg transition-all ${styles.button}`}
            >
              {confirmText}
            </button>
          </div>
