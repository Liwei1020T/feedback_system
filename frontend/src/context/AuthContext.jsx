...
export var AuthProvider = function (_a) {
    ...
    useEffect(function () {
        var handleForcedLogout = function () {
            setUser(null);
        };
        window.addEventListener("auth:logout", handleForcedLogout);
        var storedUser = localStorage.getItem(storageKeys.user);
        if (storedUser) {
            try {
    ...
    var login = useCallback(function (username, password) { return __awaiter(void 0, void 0, void 0, function () {
        var tokens;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, loginRequest(username, password)];
                case 1:
                    tokens = _a.sent();
...
var persistTokens = function (tokens) {
